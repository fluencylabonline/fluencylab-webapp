...
export default function AulasPreparadas() {
  ...
  // Fetch notebooks ordered by createdAt descending (newest first)
  ...
  // Modal state and description for new notebook creation
  ...
  // Filter notebooks based on search query (checks title and description)
            ...
            <div className="bg-white dark:bg-gray-700 rounded p-6 w-full max-w-md">
              ...
              <div className="flex justify-end space-x-2">
                <button 
                  ...
                  className="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200 font-semibold px-4 py-2 rounded"
                >
                  Cancelar
                </button>
                <button 
