...
const SentencesModal = ({ isOpen, onClose, editor }) => {
  ...
  const handleSave = () => {
    ...
    // Create a new sentences node in the editor with the text
  ...
  return (
    <div className="fixed z-50 inset-0 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen">
        ...
        <div className="bg-white text-black rounded-lg overflow-hidden shadow-xl transform transition-all w-full mx-28 h-auto p-5">
