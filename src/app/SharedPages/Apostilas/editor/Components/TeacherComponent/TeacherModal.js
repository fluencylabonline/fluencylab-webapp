...
const TextDisplayModalTeacher = ({ isOpen, onClose, initialTextTeacher, editor }) => {
  // State to manage the input text
  const [text, setText] = useState(initialTextTeacher);
...
TextDisplayModalTeacher.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
  initialTextTeacher: PropTypes.string.isRequired, // Renamed to initialText
  editor: PropTypes.object.isRequired, // Assuming editor is an object
};

export default TextDisplayModalTeacher;
