...
export default function GamesPro(){
    return(
        <div className="flex flex-wrap justify-center gap-3 p-10">
            ...
            <div className="w-52 h-auto rounded-md p-5 bg-fluency-yellow-200 dark:bg-fluency-gray-700 hover:bg-fluency-yellow-300 hover:dark:bg-fluency-gray-800 flex flex-col gap-2 items-center justify-between cursor-pointer duration-200 ease-in-out transition-all">
