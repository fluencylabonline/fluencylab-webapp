      ...
      if (id && languageareaName && moduleID) {
        try {
          const classDocRef = doc(
            ...
            "Classes",
            id
          ); // Adjust path based on your Firestore structure
    ...
    <div className="flex flex-row w-full overflow-hidden overflow-y-scroll">
      <div className="flex flex-col items-center justify-center w-full p-4 h-[90vh]">
        ...
        >
          {" "}
          {sidebarOpen ? (
            <RiMenuUnfoldLine className="w-7 h-auto" />
          ) : (
            <RiMenuUnfold2Line className="w-7 h-auto" />
          )}
        </button>
        ...
        {activePanel === "links" && (
          <div className="flex flex-col items-center justify-center w-[80%] h-full p-4">
            <iframe
              src={`https://drive.google.com/embeddedfolderview?id=${classData.externalLinks}#grid`}
              width="100%"
              height="100%"
              frameBorder={0}
            ></iframe>
        ...
        {activePanel === "quiz" && (
          <>
            {classData.deckNAME === "" ? (
              "Esta lição não contém deck para prática"
            ) : (
              <QuizComponent deckName={classData.deckNAME} />
            )}
          </>
        )}
        {activePanel === "listening" && (
          <>
            {classData.audioID === "" ? (
              "Esta lição não contém áudio para prática"
            ) : (
              <ListeningComponent audioId={classData.audioID} />
            )}
          </>
        )}
      </div>
      ...
      {/* Sidebar */}
      <div
        className={`z-10 fixed right-0 top-0 h-full flex flex-col items-center bg-fluency-pages-light dark:bg-fluency-pages-dark p-4 px-8 transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col items-center gap-2">
          <button
            className={`p-2 flex flex-row items-center gap-3 font-bold text-black dark:text-white 
                                    ${
                                      activePanel === "video"
                                        ? "text-fluency-blue-600 dark:text-fluency-blue-600"
                                        : "hover:text-fluency-blue-600 hover:dark:text-fluency-blue-600"
                                    } 
          ...
          <button
            className={`p-2 flex flex-row items-center gap-3 font-bold text-black dark:text-white 
                                    ${
                                      activePanel === "pdf"
                                        ? "text-fluency-red-600 dark:text-fluency-red-600"
                                        : "hover:text-fluency-red-600 hover:dark:text-fluency-red-600"
                                    } 
                                    duration-300 ease-in-out transition-all`}
            ...
            className={`p-2 flex flex-row items-center gap-3 font-bold text-black dark:text-white 
                                    ${
                                      activePanel === "videopdf"
                                        ...
                                        : "hover:text-amber-700 hover:dark:text-amber-700"
                                    } 
                                    duration-300 ease-in-out transition-all`}
            ...
            className={`p-2 flex flex-row items-center gap-3 font-bold text-black dark:text-white 
                                    ${
                                      activePanel === "links"
                                        ...
                                        : "hover:text-purple-700 hover:dark:text-purple-800"
                                    } 
                                    duration-300 ease-in-out transition-all`}
          ...
          <button
            className={`p-2 flex flex-row items-center gap-3 font-bold text-black dark:text-white 
                                    ${
                                      activePanel === "quiz"
                                        ? "text-fluency-orange-600 dark:text-fluency-orange-600"
                                        : "hover:text-fluency-orange-700 hover:dark:text-fluency-orange-700"
                                    } 
                                    duration-300 ease-in-out transition-all`}
          ...
          <div className="flex flex-col items-center mt-6">
            ...
            >
              <a
                ...
                href={classData.ankiLink}
              >
                <TbCards className="w-6 h-auto" />
                Baixar deck Anki
              </a>
            </button>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href={classData.pdfLink}
              >
                <BsFilePdf className="w-6 h-auto" />
                Baixar PDF
              </a>
            </button>
          </div>
