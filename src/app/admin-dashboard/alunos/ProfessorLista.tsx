...
function Paineis(){
    ...
    const handleDayChange = async () => {
        ...
        try {
            ...
            toast.success('Class days updated successfully!');
            setEditingDay(null);
...
return(
    <div className="w-full h-screen rounded-xl flex flex-col items-center mt-1 lg:px-5 px-2 py-2 bg-fluency-pages-light dark:bg-fluency-pages-dark text-fluency-text-light dark:text-fluency-text-dark">     
        ...
        <div className="text-fluency-text-light dark:text-fluency-text-dark fade-in fade-out w-full h-[95vh] overflow-y-auto mt-2">
            <div className='flex flex-col gap-3 lg:items-start md:items-start items-center'>
                ...
                {filteredStudents.map((student) => (
                    <div className="bg-fluency-gray-200 dark:bg-fluency-gray-900 w-full lg:flex lg:flex-row md:flex md:flex-row flex flex-col p-3 items-strecht justify-between rounded-lg gap-3" key={student.id}>
                        <div className='bg-fluency-gray-100 dark:bg-fluency-gray-800 w-full p-3 px-1 flex flex-col items-start justify-between rounded-lg gap-1'>
