...
export default function CriarUsuarioNovo() {
    ...
    return (
        <div className="fade-in h-[90vh] flex flex-col items-center lg:px-5 px-5 py-2 bg-fluency-bg-light dark:bg-fluency-bg-dark text-fluency-text-light dark:text-fluency-text-dark">     
