    ...
    >
      <div className="bg-fluency-bg-light rounded-lg shadow-lg p-4 h-max w-max flex flex-row items-start">
        ...
        <div className="p-2 text-fluency-blue-800">
          ...
          <div>Email: contato@fluencylab.me</div>
      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 justify-items-center">
          <div className="space-y-3">
            ...
            <ul className="space-y-1 text-fluency-gray-400 dark:text-fluency-gray-200">
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
                <a rel="noopener noreferrer" href="/u/validation">
                  Validar certificado
                </a>
              </li>
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1 text-fluency-gray-400 dark:text-fluency-gray-200">
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
                <a rel="noopener noreferrer" href="#" onClick={openModal}>
                  Fale conosco
                </a>
              </li>
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
                <a rel="noopener noreferrer" href="/u/privacy">
                  Privacidade
                </a>
              </li>
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
                <a rel="noopener noreferrer" href="/u/termsandpolicies">
                  Termos de Serviço
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase w-full text-left dark:text-gray-50 font-bold">
              Informe um problema
            </h3>
            <ul className="space-y-1 text-fluency-gray-400 dark:text-fluency-gray-200">
              <li className="hover:text-fluency-gray-500 hover:dark:text-fluency-gray-300 ease-in-out duration-300">
                <a onClick={openModal} rel="noopener noreferrer" href="#">
                  Contato
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3 flex flex-col items-center font-bold">
            ...
            <div className="flex justify-center gap-2">
              <SocialIcon
                ...
                url="https://api.whatsapp.com/send/?phone=5586999535791"
              />
              <SocialIcon
                style={{ width: "40px", height: "40px" }}
                url="https://www.threads.net/@fluency.lab"
              />
              <SocialIcon
                style={{ width: "40px", height: "40px" }}
                url="https://www.instagram.com/fluency.lab/"
              />
            </div>
          </div>
        </div>
