        ...
        <div className="lg:flex lg:flex-row md:flex md:flex-grid sm:flex sm:flex-grid justify-center mt-2 gap-2 p-4">
            ...
            <Link href="aulas-gravadas/modulo-2">
                ...
                <div className="relative z-10 mx-auto max-w-md">
                    ...
                    <div className="pt-5 text-base font-semibold leading-7">
                    <p>
                        <a href="aulas-gravadas/modulo-2" className="text-fluency-green-600 text-3xl font-bold transition-all duration-300 group-hover:text-white">Inglês - Módulo 2 &rarr;</a>
                    </p>
                    </div>
                </div>
                </div>
            ...
            <div className="mt-4 group relative cursor-pointer overflow-hidden px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
            <Link href="aulas-gravadas/modulo-3">
                <div>
                ...
                <div className="relative z-10 mx-auto max-w-md">
                    ...
                    <div className="pt-5 text-base font-semibold leading-7">
                    <p>
                        <a href="aulas-gravadas/modulo-3" className="text-fluency-yellow-500 text-3xl font-bold transition-all duration-300 group-hover:text-white">Inglês - Módulo 3 &rarr;</a>
                    </p>
                    </div>
                </div>
                </div>
