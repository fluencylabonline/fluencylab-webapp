  ...
  return (
    <NodeViewWrapper className="react-component">
      <div className="flex flex-col text-black dark:text-white p-4 my-4">
        ...
        <div className='lg:relative block top-10 left-[14rem] md:flex flex-row items-center justify-center bg-fluency-gray-100 dark:bg-fluency-gray-500 text-black dark:text-white lg:w-[70%] lg:h-[7rem] md:h-full h-fit rounded-3xl lg:mb-20 mb-10 lg:py-0 md:py-2 py-0'>
...
const SpeakWord = ({ word }) => {
  ...
  return (
    ...
    >
      ...
      <span
        onClick={speak}
        className="cursor-pointer hover:text-fluency-orange-600 ease-in-out transition-all duration-300 font-bold"
      >
        {word}
      </span>
    </div>
