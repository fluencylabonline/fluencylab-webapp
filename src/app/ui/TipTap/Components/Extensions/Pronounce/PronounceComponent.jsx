          ...
          {selectedAudio ? (
            <div className='flex flex-col items-center gap-2'>
              <div className='text-sm rounded-md bg-fluency-bg-light dark:bg-fluency-bg-dark p-4 w-full'>
                ...
                <p>Quando estiver pronto, aperte o botão falar e leia o texto em voz alta. Quando terminar, clique em Parar e veja sua pontuação. <span className='text-fluency-orange-600 font-semibold'>Talvez você precise tentar mais de uma vez. Este ainda é um recurso em teste.</span></p>
              </div>
